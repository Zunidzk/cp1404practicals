...
def repeat_string(s, n):
    ...
    message = s
    for numbermultiple in range(n-1):
        message = " ".join([message, s])
    return message
...
def run_tests():
    ...
    assert test_car.fuel == 10, "Car passed fuel is 10"
    # assert test_car.fuel == 0, "Car default fuel is 0"
...
def format_as_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> format_as_sentence('this is a valid phrase')
